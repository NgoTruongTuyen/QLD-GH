...
public class QTVTaoTaiKhoan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel8.add(btnCreate, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 210, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QTVTaoTaiKhoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QTVTaoTaiKhoan().setVisible(true);
            }
        });
    }
