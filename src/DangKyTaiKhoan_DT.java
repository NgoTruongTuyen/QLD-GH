...
public class DangKyTaiKhoan_DT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel7.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 490, 190, 40));
        ...
        jPanel7.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 330, 210, 40));

        txtOrderPerDay.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtOrderPerDay, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 280, 260, 40));
        ...
        jPanel7.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 190, 40));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel18.setText("Số chi nhánh");
        jPanel7.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 190, 40));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel19.setText("Số lượng đơn hàng mỗi ngày");
        jPanel7.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, 280, 40));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel20.setText("Số điện thoại");
        jPanel7.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 440, 190, 40));

        jLabel21.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel21.setText("Địa chỉ kinh doanh");
        jPanel7.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 380, 190, 40));

        txtTypeOfGood.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtTypeOfGood, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 330, 260, 40));

        txtDistrict.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtDistrict, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 170, 260, 40));

        txtBranchQuantity.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtBranchQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 230, 260, 40));

        txtAddress.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 380, 260, 40));

        txtPhonenumber.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtPhonenumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 440, 260, 40));

        txtMail.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtMail, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 490, 260, 40));
