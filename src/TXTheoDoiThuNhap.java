 ...
 * @author zerotus
 */
public class TXTheoDoiThuNhap extends javax.swing.JFrame {
    String userID;
    String userType;
    String currentUser;
    ...
    ResultSet rs = null;
    /**
     * Creates new form TXTheoDoiThuNhap
     */
    public TXTheoDoiThuNhap() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel8.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 10, 210, 60));
        ...
        jPanel8.add(txtTotalIncome, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, 160, 40));
    ...
    public void loadData() {
        ...
        try {
            ...
            pstmt = conn.prepareStatement("select * from DONHANG where MATX = ?");
            pstmt.setString(1, userID);
            rs = pstmt.executeQuery();
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < nums; i++) {
                    ...
                    cost = Integer.parseInt(rs.getString("PHIVANCHUYEN"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TXTheoDoiThuNhap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TXTheoDoiThuNhap().setVisible(true);
            }
        });
    }
